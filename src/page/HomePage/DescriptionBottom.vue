  ...
  <div class="footer">
    <div class="footer-sec">
      ...
      <div class="footer-menu">
        <a href="#about-sec" class="footerMenuStyle">About</a>
        <a href="#technology-sec" class="footerMenuStyle">Technology</a>
        <a href="#team-sec" class="footerMenuStyle">Team</a>
        <a href="#blog-sec" class="footerMenuStyle">Blog</a>
      </div>
      ...
      <div class="footer-copyright">
        <p>Copyright © 2022 Fragcolor Pte. Ltd.</p>
      </div>
    </div>
  </div>
</template>
