...
<template>
  <div class="mainPage team-page">
    ...
    <div class="body">
      ...
      <div class="team-page-members-desktop">
        ...
        <div class="row">
          <div class="team-page-member-sec">
            ...
            <div class="team-page-member-sec-social">
              <a
                href="https://www.linkedin.com/in/giovanni-petrantoni/"
                target="_blank"
                class="team-page-social-icon-holder"
              >
          ...
          <div class="team-page-member-sec">
            ...
            <p>
              Head of UX @ Fragcolor <br />10y+ Game Industry (game engines) <br />
              Financial services
            </p>
            <div class="team-page-member-sec-social">
              <a
                href="https://www.linkedin.com/in/nmusset/"
                target="_blank"
                class="team-page-social-icon-holder"
              >
                <linkedIn class="team-page-social-icon" />
        ...
        <div class="row">
          <div class="team-page-member-sec">
            ...
            <p>
              Head of Marketing @ Fragcolor<br />
              5 years+ Art & Technology (DNS, Digital Arts, Media)
            </p>
            <div class="team-page-member-sec-social">
              <a
                href="https://www.linkedin.com/in/aleksandraart/"
                target="_blank"
                class="team-page-social-icon-holder"
              >
                <linkedIn class="team-page-social-icon" />
          ...
          <div class="team-page-member-sec">
            ...
            <div class="team-page-member-sec-social">
              <a
                href="https://www.linkedin.com/in/bbittencourt/"
                target="_blank"
                class="team-page-social-icon-holder"
              >
                <linkedIn class="team-page-social-icon" />
          ...
          <div class="team-page-member-sec">
            ...
            <h4>Pauline Chi</h4>
            <p>
              Head of Web Development @ Fragcolor <br />
        ...
        <div class="row">
          <div class="team-page-member-sec">
            ...
            <div class="team-page-member-sec-social">
              <a
                href="https://www.linkedin.com/in/satendrapals/"
                target="_blank"
                class="team-page-social-icon-holder"
              >
                <linkedIn class="team-page-social-icon" />
          ...
          <div class="team-page-member-sec">
            ...
            <p>
              Game Designer @ Fragcolor <br />
              Game development (Unity), design and interactive installations
            </p>
            <div class="team-page-member-sec-social">
      ...
      <a
        href="https://www.linkedin.com/company/fragcolor/jobs/"
        target="_blank"
        style="text-decoration: none"
      >
        <div class="team-join-us-btn">
